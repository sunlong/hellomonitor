...
public enum MessageCode implements IMsgCode{
    ...
    VALIDATION_ERROR,
    METHOD_NOT_OVERRIDE_ERROR,

    DEVICE_CLASS_EXIST_ERROR,
    TEMPLATE_EXIST_ERROR,
    TEMPLATE_NOT_EXIST_ERROR,
    DATA_SOURCE_NOT_EXIST_ERROR,
    GRAPH_NOT_EXIST_ERROR,
    DEVICE_NOT_EXIST_ERROR,
    DEVICE_EXIST_ERROR,
    DEVICE_CLASS_NOT_EXIST_ERROR,
    DATA_SOURCE_EXIST_ERROR,
    GRAPH_EXIST_ERROR,
    GRAPH_POINT_NOT_EXIST_ERROR,
    GRAPH_POINT_EXIST_ERROR,
    DATA_POINT_NOT_EXIST_ERROR,
    DATA_POINT_EXIST_ERROR,
}