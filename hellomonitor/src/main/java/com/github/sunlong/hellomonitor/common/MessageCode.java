...
public enum MessageCode implements IMsgCode{
    ...
    GRAPH_NOT_EXIST_ERROR, DEVICE_NOT_EXIST_ERROR, DEVICE_EXIST_ERROR, DEVICE_CLASS_NOT_EXIST_ERROR, DATA_SOURCE_EXIST_ERROR, GRAPH_EXIST_ERROR, GRAPH_POINT_NOT_EXIST_ERROR, GRAPH_POINT_EXIST_ERROR, DATA_POINT_NOT_EXIST_ERROR, DATA_POINT_EXIST_ERROR,
}